//*******************************************************************
/*!
\file   DisplayGraphic_OTM8009A.h
\author Thomas Breuer
\date   27.11.2018
*/

//*******************************************************************
#ifndef _HW_DISPLAY_GRAPHIC_OTM8009A_H
#define _HW_DISPLAY_GRAPHIC_OTM8009A_H
...
//*******************************************************************
/*!
\class DisplayGraphic_OTM8009A

\brief LCD display OTM8009A

\example  HwDisplayGraphic.cpp
*/
class DisplayGraphic_OTM8009A : public DisplayGraphic
{
  public:
    //---------------------------------------------------------------
    typedef enum
...
//*******************************************************************
/*!
\class DisplayGraphic_OTM8009Acmd

\brief LCD display OTM8009A

\example  HwDisplayGraphic.cpp
*/
class DisplayGraphic_OTM8009Acmd : public DisplayGraphic_OTM8009A
{
  public:
    //---------------------------------------------------------------
    DisplayGraphic_OTM8009Acmd( Dsi_Mcu      &hwDSI,
                                Port::Pin    &resetPin,
                                Orientation   orientation,
                                Font          font,
                                BYTE          zoom = 1 );
...
//*******************************************************************
/*!
\class DisplayGraphic_OTM8009Aram

\brief LCD display OTM8009A

\example  HwDisplayGraphic.cpp
*/
class DisplayGraphic_OTM8009Aram : public DisplayGraphic_OTM8009A
{
  public:
    //---------------------------------------------------------------
    DisplayGraphic_OTM8009Aram( Dsi_Mcu      &hwDSI,
                                Port::Pin    &resetPin,
                                Orientation   orientation,
                                Font          font,
                                BYTE          zoom = 1 );
