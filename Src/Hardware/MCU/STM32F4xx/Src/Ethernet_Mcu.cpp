...

{
  ...
  const uint16_t pmode = PinConfig::HIGH_SPEED | PinConfig::NO_PUPD;
   ...
   PinConfig::set( PinConfig::ETH_MII_TX_EN,  pmode | PinConfig::PUSH_PULL  );
   PinConfig::set( PinConfig::ETH_MII_TXD0,   pmode | PinConfig::PUSH_PULL  );
   PinConfig::set( PinConfig::ETH_MII_TXD1,   pmode | PinConfig::PUSH_PULL  );
   PinConfig::set( PinConfig::ETH_MII_RXD0,   pmode | PinConfig::INPUT      ); // no mode
   PinConfig::set( PinConfig::ETH_MII_RXD1,   pmode | PinConfig::INPUT      ); // no mode

  //ETH_MII_RX_ER_PD_5 rxer 7 output from LAN
  //PinConfig::set( PinConfig::ETH_RX_ER, pmode | PinConfig::INPUT      );

   PinConfig::set( PinConfig::ETH_MII_RX_DV,  pmode | PinConfig::OPEN_DRAIN );// PUSH_PULL
   PinConfig::set( PinConfig::ETH_MDC,    pmode | PinConfig::PUSH_PULL  );// no mode
   PinConfig::set( PinConfig::ETH_MDIO,   pmode | PinConfig::OPEN_DRAIN ); // PUSH_PULL
   PinConfig::set( PinConfig::ETH_MII_RX_CLK, pmode | PinConfig::OPEN_DRAIN );// PUSH_PULL
...
bool Ethernet_Mcu::InitEth( void )
{
  ...
  tmpreg  = ETH->MACMIIAR;
  tmpreg &= ~ETH_MACMIIAR_CR;  // Clear CSR Clock Range CR[2:0] bits
                                        ...
                                        uint16_t PHYReg )
{
  ...
  tmpreg &= ETH_MACMIIAR_CR;    // Keep only the CSR Clock Range CR[2:0] bits value
